...
data_raw <- read_excel("bacteria_abundance.xlsx", sheet = 1)  
...
write.table(bray_matrix, "bacteria_bray_curtis.txt", sep = "\t", quote = FALSE)
...
ggsave("bacteria_pcoa1.png", plot = p, width = 5, height = 5, dpi = 600)  
ggsave("bacteria_pcoa1.tiff", plot = p, width = 5, height = 5, dpi = 600)  
ggsave("bacteria_pcoa1.pdf", plot = p, width = 5, height = 5)  
...
ggsave("bacteria_pcoa_ellipse.png", plot = p_with_ellipse, width = 5, height = 5, dpi = 600)  
ggsave("bacteria_pcoa_ellipse.tiff", plot = p_with_ellipse, width = 5, height = 5, dpi = 600)  
ggsave("bacteria_pcoa_ellipse.pdf", plot = p_with_ellipse, width = 5, height = 5)  

png(file = "bacteria_bray_pcoa.png", width = 5, height = 5, res = 600, units = "in")  
...
tiff(file = "bacteria_bray_pcoa.tiff", width = 5, height = 5, res = 600, units = "in")  
p_marginal <- ggMarginal(
  p_with_ellipse,
  type = "density",
  margins = "both",
...
pdf(file = "bacteria_bray_pcoa.pdf", width = 5, height = 5)  
p_marginal <- ggMarginal(
  p_with_ellipse,
  type = "density",
  margins = "both",
